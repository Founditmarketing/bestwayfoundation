 ...
 * Homepage FAQ.
 *
 * The homepage previously answered no questions at all. These are the ones
 * people ask before they know which service they need, kept distinct from the
 * per-service and per-city sets so no two FAQPage blocks on the site duplicate
 * each other.
 */

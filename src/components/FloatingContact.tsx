        ...
        {isOpen && (
          ...
          >
            ...
            <div className="bg-jac-charcoal p-6 text-center border-b-[4px] border-jac-lime">
              ...
              <a href="tel:9362385604" className="inline-flex items-center justify-center gap-2 bg-jac-lime text-jac-charcoal px-6 py-3 rounded-full font-bold hover:bg-white transition-colors w-full">

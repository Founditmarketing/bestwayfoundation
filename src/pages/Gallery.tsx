    ...
    <>
      ...
      <section className="bg-white py-24 md:py-32">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <a href="https://www.facebook.com/profile.php?id=61589371986773" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 bg-[#1877F2] text-white px-8 py-4 rounded-full font-bold tracking-wide uppercase hover:bg-[#0e5fc5] transition-colors shadow-lg">
      ...
      <section className="bg-jac-green py-16 md:py-20">
        <div className="max-w-[1400px] mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/contact" className="w-full sm:w-auto bg-jac-lime text-jac-green px-8 py-4 rounded-full font-bold uppercase tracking-wider hover:bg-white transition-colors flex items-center justify-center gap-2 shadow-md">
              Get a Free Quote <ArrowRight className="w-5 h-5" />
            </Link>
            <a href="tel:9039328150" className="w-full sm:w-auto border-2 border-white text-white px-8 py-4 rounded-full font-bold uppercase tracking-wider hover:bg-white hover:text-jac-green transition-colors flex items-center justify-center gap-2">

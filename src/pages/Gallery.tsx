      ...
      <section className="bg-jac-dark py-24 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a href="tel:9039328150" className="w-full sm:w-auto border-2 border-white text-white px-8 py-4 font-bold uppercase tracking-wider hover:bg-white hover:text-jac-charcoal transition-colors text-center">
              (903) 932-8150
            </a>
          </div>
        </div>

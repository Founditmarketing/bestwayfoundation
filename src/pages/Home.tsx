        ...
        <div className="max-w-[1400px] mx-auto px-6 flex flex-col items-center justify-center gap-4 text-center">
          <div>
            <h2 className="font-display font-bold text-2xl md:text-3xl lg:text-4xl leading-tight text-white uppercase tracking-wide mb-2">
              Longview's Trusted Foundation Experts
            </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-0 relative z-10">
          ...
          <div className="flex items-center px-8 lg:pl-16 lg:pr-12 py-12 lg:py-28 w-full justify-center lg:justify-start">
            <div className="max-w-xl">
              <div className="text-jac-lime font-bold tracking-widest uppercase text-sm mb-2">The Choice of Longview</div>
        ...
        <div className="max-w-[1400px] mx-auto px-6 relative z-10 text-center">
          ...
          <div className="flex flex-col items-center gap-6 justify-center text-white">
            <div className="flex flex-col items-center gap-1">
              <a href="tel:9039328150" className="text-3xl md:text-5xl font-bold hover:text-white/80 tracking-wide">
                (903) 932-8150
              </a>
            </div>
          ...
          <div className="flex flex-col gap-10 lg:pr-8">
              ...
              <div className="space-y-6 text-gray-300">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:9039328150" className="text-xl font-medium hover:text-jac-lime transition-colors">(903) 932-8150</a>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="leading-relaxed text-gray-400 mb-1">Longview, TX, United States</p>
                    <p className="text-sm text-gray-500 italic">Proudly serving Longview and all surrounding areas.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="h-[400px] w-full relative border border-white/10 overflow-hidden bg-gray-900 rounded-sm shadow-xl">
              ...
              <div className="absolute top-1/2 left-1/2 z-20 flex flex-col items-center pointer-events-none -translate-x-1/2 -translate-y-1/2">
                <div className="bg-white text-jac-charcoal text-[10px] md:text-xs font-bold px-2 py-1 rounded shadow-lg whitespace-nowrap mb-1 uppercase tracking-wide border border-jac-lime">HQ - Longview, TX</div>

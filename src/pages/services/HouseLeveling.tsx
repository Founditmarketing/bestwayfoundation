    ...
    <ServiceTemplate
      ...
      content={
        <>
          ...
          <p>
            Proudly serving Lufkin and all surrounding areas, we’re dedicated to results that last. When your home needs to be lifted, leveled, or stabilized, trust Best Way to restore its foundation and your peace of mind.
          </p>

    ...
    <ServiceTemplate
      ...
      content={
        <>
          ...
          <p>
            Proudly serving Lufkin and all surrounding areas, we’re dedicated to delivering results that stand firm for decades. When it comes to foundation repair, trust Best Way to strengthen your home from the ground up.
          </p>

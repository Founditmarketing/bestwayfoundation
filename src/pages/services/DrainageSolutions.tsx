...
const PAGE_DESCRIPTION =
  'French drains, grading and vapor barrier solutions that protect your foundation from water damage across Deep East Texas. Free inspections. Call (903) 932-8150.';

export default function DrainageSolutions({ isLoading }: { isLoading?: boolean }) {
  useSeo({
    title: 'Foundation Drainage Solutions in Longview, TX | Best Way Foundation Repair',
    description: PAGE_DESCRIPTION,
    canonicalPath: '/services/drainage-solutions',
    jsonLd: [
      {
        ...
        description: PAGE_DESCRIPTION,
        url: `${origin}/services/drainage-solutions`,
        provider: {
      ...
      },
      {
        ...
        itemListElement: [
          { '@type': 'ListItem', position: 1, name: 'Home', item: `${origin}/` },
          {
            ...
            position: 2,
            name: 'Drainage Solutions',
            item: `${origin}/services/drainage-solutions`,
          },
        ],
      },
    ],
